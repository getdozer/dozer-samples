...
const MASTER_TOKEN = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjYWNoZV91c2VyIiwic3ViIjoiYXBpQGRvemVyLmNvbSIsImV4cCI6MTY4MTM3NTM2MTI1OCwiYWNjZXNzIjoiQWxsIn0.jsn-8z2A9qyc21DBp9AlhbJPQmIEC45tmim2Lx4EkgY';
app.post('/admin/login', function(req, res){
    ...
    if(!req.body.username || !req.body.password){
        ...
        if (req.body.username == 'karolis' && req.body.password == 'slaptas') {
